...
summary: "Canonical bug bounty workflow note migrated from 4 Notion source page(s), preserving commands, links, and resource references."
tags:
  - workflow
  - methodology
  - bug-bounty
...
Canonical bug bounty workflow note migrated from 4 Notion source page(s), preserving commands, links, and resource references.

## Source Provenance

- `Private & Shared/XettaтАЩs Web AppSEC Notes/TIPS 03af46c2c9954890be1ae8910e9ba344.md` (93 words, 5 external links)
- `Private & Shared/XettaтАЩs Web AppSEC Notes/Tips From EMAD Shanab df876bcc54004ddebf09e7543a538d60.md` (2815 words, 114 external links)
- `Private & Shared/XettaтАЩs Web AppSEC Notes/Workflow Cheatsheet 99bf8927e2b94472933fa8877ac55f80.md` (163 words, 11 external links)
- `Private & Shared/XettaтАЩs Web AppSEC Notes/checklist fc6500d29706427bb09b30824ea5a2ec.md` (88 words, 6 external links)
...
First, identify your target and find the subdomains using various tools available on Github, Shodan, etc. You can also use public-bugbounty-programs from chaos or arkadiyt.
...
[Hunting-Tips/Bounty-Tips.md at main · Fawadkhanfk/Hunting-Tips](https://github.com/Fawadkhanfk/Hunting-Tips/blob/main/Bounty-Tips.md?fbclid=IwAR0RAot02VmNROpIdqiEvdqqt2wqWyMHw8_-F3ruJ2geF9XyQkOk9G2w1m0)


[hacking website by shell uploading](http://www.securityidiots.com/Web-Pentest/hacking-website-by-shell-uploading.html?fbclid=IwAR3e2F5X1lZOeaE2JLaUAKb5kKIjIFiuaap1O2OADg4yMjwIx1SPHtYzcF4)


[](https://medium.com/@cc1h2e1/bug-bounty-check-list-by-c1-2beb7ae3c116)


[Information Gathering&scanning for sensitive information[ Reloaded ]](https://0xjoyghosh.medium.com/information-gathering-scanning-for-sensitive-information-reloaded-6ff3455e0d4e)
...
[https://github.com/ivan-sincek/penetration-testing-cheat-sheet](https://github.com/ivan-sincek/penetration-testing-cheat-sheet)
...
[https://pentester.land/](https://pentester.land/blog/subdomains-enumeration-cheatsheet/)

- After subdomain Enum

    [https://twitter.com/tabaahi_/status/1568568298710892546](https://twitter.com/tabaahi_/status/1568568298710892546)
